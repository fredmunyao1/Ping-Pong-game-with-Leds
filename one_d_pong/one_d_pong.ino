...
#define PIN_WSDATA		5		// LED data,,..DIN
#define PIN_BUT_RS		3		// Right start/hit button,,,BUTTONRIGHT 12
#define PIN_BUT_RP		4		// Right power-up button BUTTON LEFT 11
#define PIN_BUT_LS		12		// Left start/hit button BUTTON RIGHT 3
#define PIN_BUT_LP		11	// Left power-up button  BUTTON LEFT 4
#define PIN_SOUND		9		// Buzzer output (PB1/OC1A) BUZZER

#define NPIXELS			84		// Number of pixels to handle
